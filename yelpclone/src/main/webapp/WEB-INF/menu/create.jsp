...
<head>
<meta charset="UTF-8">
<title>${oneRestaurant.name} - Create Menu</title>
...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-8">
                <h3>Create a Menu for ${oneRestaurant.name}</h3>

                <form action='/save/menu/restaurant/${oneRestaurant.id}' method='post' enctype='multipart/form-data'>
                <p>
